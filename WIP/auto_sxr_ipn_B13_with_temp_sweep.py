...
# open data file
outfp = open('..\\data\\SXR_Band13_PN_LDO_'+LDO_offset+'_chip_'+part+'_temp'+temperature+'.csv', 'w')
...
dutlib.enableCGEN()
# setup Rx PLL
modelib.setupRxPath(751, Rx_Path=2, FE_Path="L2", adc_option="y", gindex=0, bw=20)

#reduce Gain: Binh added 06/15/17
#rlib.WriteRficRegister(0x578, 0x1F28)
#rlib.WriteRficRegister(0x584, 0x86FD)
...
for bw in bw_array:	
	...
	for lofac in rx_lo_range: #[777, 782, 787, 832, 847, 862]: #band 13, band 20
		...
		SG5182.SetSgOn(sg, RF_Freq_MHz*1e6, -15) # Set Rx RF in at -55dBm
