...
outfp = open('..\\data\\SXR_VCOH_openloop_LDO'+LDO_offset+'_chip'+part+'_temp'+temperature+'.csv', 'w')
...
for CSW in range(0,512,1):
	...
	if CSW>450:
		RF_Freq_MHz = RF_Freq_MHz - 29-20 # 28
	elif CSW>400:
		...
		RF_Freq_MHz = RF_Freq_MHz - 10-7 # 9
	elif CSW>200:
	...
	SG5182.SetSgOn(sg, RF_Freq_MHz*1e6, -55) # Set Rx RF in
