...
"""
General notes: 
	Looks like all the events are subclasses of wx.Event
	Wx debugging techniques:
  ...
  The above are commands you set, which adjust how the error screen is displayed
  
  Also: there is a demo in the package that you can find and test out!
  I bet there is one for pySerial as well...
"""