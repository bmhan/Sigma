...
#
# The program sweeps the rb values and the gain values. 
# The program begins by calibrating the CSW and by prompting the user for a range
# of gain values to test.
#
